...
![Screen Shot 2017-04-04 at 10.33.00 AM.png](https://github.com/DataQualityCommittee/documentation/blob/master/guidance/images/cashflows02.png?raw=true)] 
...
#### Extension Elements in the Cash Flow Statement

Extension elements defined in the cash flow statement must be included in the calculations associated with the statement. All extensions comprising the change in cash for the period by default have to be included in the calculation relationships to represent the actual change in cash for the period.
...
More specific extensions should be linked via the calculation linkbase [[1]](#_ftn1) to the parent element _ProceedsFromMinorityShareholders_. One example from an actual filing is _ProceedsFromStockOptionsExercisedOfSubsidiary__._
...
More specific extensions should be linked via the calculation linkbase to the parent element _PaymentsToMinorityShareholders_. One example from an actual filing is _SharesofSubsidiaryRepurchasedforShareAwardPlan._
