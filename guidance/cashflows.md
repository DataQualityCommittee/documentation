# <a name="_Toc488070723"></a><a name="_Toc488070721"></a><a name="_Toc487815191">230 Statement of Cash Flows</a>
...
[![](images/cashflows02.png?raw=true
			alt=)](http://test.xbrl.us/php/dispatch.php?Task=xbrlChildrenGraph&Accession=0001064728-17-000026&Linkbase=Presentation&GroupURI=http://www.peabodyenergy.com/role/ConsolidatedStatementsOfCashFlows&API_Key=40d3c007-9e02-49ed-bc4b-83e379360ef2) 
...
### <a name="_Toc488070724">230-10-45 - Cash, Cash Equivalents, Restricted Cash and Restricted Cash Equivalents</a>
...
![](images/cashflows03.png?raw=true
		alt=)
...
![](images/cashflows04.png?raw=true
		alt=)
...
### <a name="_Toc488070725">230-10-45 - Gross and Net Cash Flows</a>
...
### <a name="_Toc488070726">230-10-45 - Cash Flows from Investing Activities</a>
...
### <a name="_Toc488070727">230-10-45 - Cash Flows from Financing Activities</a>
...
![](images/cashflows05.png?raw=true
		alt=)
...
### [230-10-45](https://asc.fasb.org/extlink&oid=99402803&loc=d3e3521-108585) <a name="_Toc488070729"></a>- Reporting Operating, Investing, and Financing Activities
...
[![](images/cashflows06.png?raw=true
			alt=)](https://www.sec.gov/Archives/edgar/data/1657853/000165785316000057/hghq32016form10-q.htm) 
...
![](images/cashflows07.png?raw=true
		alt=)
...
[**![](images/cashflows08.png?raw=true
				alt=) **](https://www.sec.gov/Archives/edgar/data/1111711/000111171117000037/ni-20161231x10ka.htm) 
...
[![](images/cashflows01.png?raw=true
			alt=)](https://www.sec.gov/Archives/edgar/data/1657853/000165785316000057/hghq32016form10-q.htm) 
...
**![](images/cashflows09.png?raw=true
			alt=)** 
...
Investing and financing items should only use cash flow items in the reconciliation. See rule [DQC_004](https://xbrl.us/dqc_0044) <u>4</u>

### [230-10-45](https://asc.fasb.org/extlink&oid=99402803&loc=d3e3602-108585) <a name="_Toc488070730"></a>- Reconciliation of Net Income and Net Cash Flow from Operating Activities
...
![](images/cashflows10.png?raw=true
		alt=)
...
[![](images/cashflows11.png?raw=true
			alt=)](https://test.xbrl.us/php/dispatch.php?Task=xbrlChildrenGraph&AccessionID=182849&Linkbase=Calculation&GroupURI=http://acornenergy.com/role/StatementsOfCashFlows&API_Key=4cd4576a-aada-4d35-9e40-dc7f0734f8d6) 
...
[**230-10-50**](https://asc.fasb.org/extlink&oid=98513485&loc=d3e4297-108586) - Interest and Income Tax Paid
...
When reporting income taxes paid, use the element _I_ _ncomeTaxesPaidNet_ when the amount is net of tax refunds. Use the element _I__ncomeTaxesPaid_when the amount is known to be gross of tax refunds.

##### Rules

In the cash flow statement if the element _InterestPaid_ is included in supplemental cash flows, then the element_InterestPaidNet_should also be disclosed. See Rule DQC_0065

<a name="_Toc488070731">230-10-50 - Noncash Investing and Financing Activities</a>
...
<p>
If a company does make this disclosure, then do not use the element	<em>CapitalExpendituresIncurredButNotYetPaid</em><em>.</em> Instead use the
extension element	<em>ChangeInCapitalExpendituresIncurredButNotYetPaid.</em><em> </em>
</p>
<strong>
	<br clear=)
...
[![](images/cashflows13.png?raw=true
			alt=)](https://test.xbrl.us/php/dispatch.php?Task=xbrlFactID&FactID=126580812) 
...
[![](images/cashflows14.png?raw=true
		alt=)](http://test.xbrl.us/php/dispatch.php?Task=xbrlFactID&FactID=137375182)
...
### [205-20-50](https://asc.fasb.org/link&sourceid=SL51723644-108585&objid=99402803) <a name="_Toc488070732"></a>- Disclosures Required for a Discontinued Operation Comprising a Component or Group of Components of an Entity
...
![](images/cashflows15.png?raw=true
		alt=)
...
![](images/cashflows16.png?raw=true
		alt=)
...
![](images/cashflows17.png?raw=true
		alt=)
...
![](images/cashflows18.png?raw=true
		alt=)
...
[![](images/cashflows19.png?raw=true
			alt=)](https://www.sec.gov/Archives/edgar/data/7032/000144530512001595/q22012aramark.htm) 
...
![](images/cashflows20.png?raw=true
		alt=)
...
![](images/cashflows21.png?raw=true
		alt=)
...
### <a name="_Toc488070734">830-230-45 Foreign Currency Matters</a>
...
[![](images/cashflows22.png?raw=true
			alt=)](https://www.sec.gov/Archives/edgar/data/733269/000073326915000041/f10q.htm#1) 
...
![](images/cashflows23.png?raw=true
		alt=)
